...
#ifndef __DominantPath__dominantpath__
#define __DominantPath__dominantpath__
...
private:
    ...
    double getLoss2(const PointG2 *p, const EdgeG2 &edge) const;
...
#endif /* defined(__DominantPath__dominantpath__) */
